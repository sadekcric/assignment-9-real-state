...
const Testimonial = () => {
  ...
  return (
    <div className="mt-10 lg:mt-24 container mx-auto p-3">
      ...
      <div data-aos="zoom-in" data-aos-delay="500" data-aos-duration="1500" className="hidden lg:block">
        <Swiper
          slidesPerView={3}
          spaceBetween={30}
          freeMode={true}
      ...
      <div data-aos="zoom-in" data-aos-delay="500" data-aos-duration="1500" className="lg:hidden">
        <Swiper
          slidesPerView={1}
          spaceBetween={30}
          freeMode={true}
